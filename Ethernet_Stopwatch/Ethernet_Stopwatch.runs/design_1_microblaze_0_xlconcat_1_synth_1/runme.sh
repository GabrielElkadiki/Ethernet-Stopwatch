...
HD_PWD='W:/Desktop/ethernet/ethernet.runs/design_1_microblaze_0_xlconcat_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_microblaze_0_xlconcat_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_microblaze_0_xlconcat_1.tcl
