...
CONFIG.PHASE {0.000} \
  ...
  set Master_controller_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Master_controller:2.0 Master_controller_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /Master_controller_0/s00_axi]
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs Master_controller_0/s00_axi/reg0] SEG_Master_controller_0_reg0
