...
HD_PWD='w:/desktop/phase_3/stopwatch_1/ip_repo/edit_Master_controller_v2_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Master_controller_v2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Master_controller_v2_0.tcl
