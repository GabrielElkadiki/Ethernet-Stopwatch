...
HD_PWD='W:/Desktop/ethernet/ethernet.runs/design_1_rst_mig_7series_0_75M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_mig_7series_0_75M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_mig_7series_0_75M_0.tcl
