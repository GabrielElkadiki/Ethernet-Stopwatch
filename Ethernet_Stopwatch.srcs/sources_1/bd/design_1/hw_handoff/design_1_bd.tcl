...
CONFIG.PHASE {0.000} \
  ...
  set Master_controller_0 [ create_bd_cell -type ip -vlnv carleton.ca:user:Master_controller:3.0 Master_controller_0 ]
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins Master_controller_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net Master_controller_0_an [get_bd_ports an] [get_bd_pins Master_controller_0/an]
  connect_bd_net -net Master_controller_0_mode_led [get_bd_ports mode_led] [get_bd_pins Master_controller_0/mode_led]
  connect_bd_net -net Master_controller_0_ready_flash [get_bd_ports ready_flash] [get_bd_pins Master_controller_0/ready_flash]
  connect_bd_net -net Master_controller_0_seg [get_bd_ports seg] [get_bd_pins Master_controller_0/seg]
  connect_bd_net -net Master_controller_0_speaker [get_bd_ports speaker] [get_bd_pins Master_controller_0/speaker]
  ...
  connect_bd_net -net mode_1 [get_bd_ports mode] [get_bd_pins Master_controller_0/mode]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins Master_controller_0/s00_axi_aresetn] [get_bd_pins axi_ethernetlite_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  connect_bd_net -net start_1 [get_bd_ports start] [get_bd_pins Master_controller_0/start]
  connect_bd_net -net stop_1 [get_bd_ports stop] [get_bd_pins Master_controller_0/stop]
  connect_bd_net -net stopwatch_reset_1 [get_bd_ports stopwatch_reset] [get_bd_pins Master_controller_0/reset]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_1/clk_in1]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs Master_controller_0/S00_AXI/S00_AXI_reg] SEG_Master_controller_0_S00_AXI_reg
...
preplace inst Master_controller_0 -pg 1 -lvl 7 -y 1020 -defaultsOSRD
...
preplace netloc Master_controller_0_seg 1 7 1 NJ
preplace netloc mig_7series_0_mmcm_locked 1 4 4 1240 310 NJ 310 NJ 310 2330
...
preplace netloc microblaze_0_Clk 1 1 6 180 810 570 810 890 810 1240 810 1760 810 2080
preplace netloc microblaze_0_axi_periph_M03_AXI 1 3 1 860
preplace netloc microblaze_0_intc_axi 1 3 1 920
...
preplace netloc microblaze_0_axi_dp 1 2 4 580 110 NJ 110 NJ 110 1690
preplace netloc stop_1 1 0 7 NJ 1010 NJ 1010 NJ 1010 NJ 1010 NJ 1010 NJ 1010 NJ
preplace netloc mig_7series_0_ui_clk 1 4 4 1240 130 1750 300 NJ 300 2340
...
preplace netloc rst_clk_wiz_1_100M_interconnect_aresetn 1 2 4 540 80 NJ 80 NJ 80 1780J
preplace netloc rst_clk_wiz_1_100M_bus_struct_reset 1 2 4 550J 120 NJ 120 NJ 120 1730
preplace netloc microblaze_0_M_AXI_IC 1 5 1 1740
preplace netloc microblaze_0_axi_periph_M01_AXI 1 3 4 880 790 NJ 790 NJ 790 NJ
preplace netloc enc_sw_1 1 0 7 NJ 1090 NJ 1090 NJ 1090 NJ 1090 NJ 1090 NJ 1090 NJ
preplace netloc Master_controller_0_speaker 1 7 1 NJ
preplace netloc rst_clk_wiz_1_100M_peripheral_aresetn 1 2 5 580 830 910 830 NJ 830 1770 830 2060
preplace netloc rst_clk_wiz_1_100M_mb_reset 1 2 3 560J 580 920 580 1230J
preplace netloc clk_wiz_1_locked 1 1 1 200
preplace netloc axi_uartlite_0_UART 1 7 1 NJ
preplace netloc axi_ethernetlite_0_ip2intc_irpt 1 2 5 600 590 870J 610 NJ 610 NJ 610 2040
preplace netloc mig_7series_0_ui_clk_sync_rst 1 4 4 1230 320 NJ 320 NJ 320 2350
...
preplace netloc Master_controller_0_an 1 7 1 NJ
...
preplace netloc Master_controller_0_ready_flash 1 7 1 NJ
preplace netloc Master_controller_0_mode_led 1 7 1 NJ
preplace netloc axi_timer_0_interrupt 1 2 3 590 150 NJ 150 1220
levelinfo -pg 1 0 100 380 730 1110 1470 1910 2210 2380 -top 0 -bot 1180
",
}
